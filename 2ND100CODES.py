...
# # print('#####################################################################################')
# # # #12upper case and lower case
# # # ch=input("enter a character here:")
# # if ch.isupper():
# #     print("upper case")
# # else:
# #     print("its a lower case letter")
...
# # else:
# #     print("not positive or odd")

# # print('#####################################################################################')
# # #15negetive and odd
# # num=5
# # if num<=10 and num%5==0:
# #     print("negetive or odd")
# # else:
# #     print("positivve or even")
...
# # print('#####################################################################################')
# # # password strong or weak
# # password="mohammadsameer123"
# # if len(password)>10:
...
# # # i need to verify  pavan bro
# # #atm withdraw
# # # balance=5000
# # # withdrawalamount=int(input("enter a balance here:"))
...
# # #     print("number in 1 and 100")
# # # else:
# # #     print("number not in 1 and 100")
# # # # Check whether password length is strong or weak
# # # password="sameer123"
# # # if len(password)<=6:
# # #     print("weak password")
...
# # # # Create ATM withdrawal condition
# # # balance=5000
...
# # reverse=name[::-1]
# # print(reverse)
# # #2)check wheather a string is palindrome or not
# # name="madam"
# # reverse=name[::-1]
# # if name==reverse:
# #     print("palindrome")
# # else:
# #     print("not a palindrome")
# # #2)checkk wheather number is palondrioome or not
# # number=2002
# # original=str(number)
# # reverse=original[::-1]
# # if original==reverse:
...
# # print('##################################################################################')
# # print('##################################################################################')
# # STRING METHODS ALL CODES FROM STARTING
# # 1)NAME PALINDROME
# # name="madam"
# # reverse=name[::-1]
# # if name==reverse:
...
# # # 4)COUNT NUMBER OF CONSONENTS IN STRING
...
# # print(count)
# # print("#####################################################################")             
# # #5)COUNT NUMBER OF WORDS IN SENTENSCES
# # name="i like python"
# # count=0
# # words=name.split()
...
# # # 6)FIND FREQUENCY OF CHARACTER IN A STRING
# # name="mohammad sameer"
# # # character=input("enter character here:")
# # count=0
# # for ch in name:
# #     if ch==character:
# #         count+=1
...
# # print("#####################################################################")             
# # #9)CONVERT STRING TO LOWER CASE
# # name="SAMEER"
# # print(name.lower())
...
# # print("#####################################################################")             
# # #11)find first character in string
# # name="sameer"
# # print(name[0])

# # print("#####################################################################")             

# # #12)find last character of string
# # name="sameer"
# # print(name[5])
...
# #15)check wheather a string is anagram or not
# name1="sameer"
# name2="study"
...
# # 16)REPLACE VOWELS IN A STRING
# name=input("enter string here:")
# result=""
# for ch in name:
#     if ch in "aeiouAEIOU":
#         result+=ch
...
# print("#####################################################################")             
# # 18)#COUNT SPECIAL CHARACTERS IN A STRING
# name=input("enter a string here:")
# count=0
# for ch in name:
#     if not ch.isalnum() and ch!="":
#         count+=1
# print("special characteer=",count)
# # 19)check wheather a string contains a only alphabets
# name="sameer123"
# if name.isalpha():
#     print("only alphabets")
# else:
#     print("non alphabets")
# #20)check wheather a string contaions a digits
# name="sameer"
# if name.isdigit():
#     print("only digits")
# else:
#     print(" non digits")
#     print("print non digits")
...
# # #4)count consonents in a string
# # name="sameer"
# # vowels="aeiou"
# # count=0
# # for ch in name:
...
# # result=name.upper()
# # print(result)
# # #remove dupicates characters in as  string
# # name="sameerrrrrrrrrrrrrrrsameee"
# # result=" "
# # for ch in name:
# #     if ch not in result:
# #         result+=ch
...
# # print("#####################################################################")  
# # #3)print iodd numbers from 1to 100
...
# #     print(n,"x",i,"=",n*i)
# #5)
# # wheather a string is palibdrome
# # number1=int(input("enter a no here:"))
# original=str(number1)
# # reverse=original[::-1]
# # if original==reverse:
